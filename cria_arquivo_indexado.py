...
def cria_arquivo_indexado():
    ...
    autores_header = "{:<300}".format(autores_header)
    ...
    avaliacao_header = "{:<100}".format(avaliacao_header)
    ...
    with open(arquivo, newline='', encoding='utf-8-sig') as csvfile:
        ...
        with open('arquivo_tamanho_fixo_indice.csv', 'w', encoding='utf-8') as arquivo_tam_fixo:
            #montagem do cabeçalho
            cabecalho = contador_header + titulo_header + autores_header + editora_header + data_publicacao_header + categorias_header + avaliacao_header
            ...
            for r in data:
                ...
                num_avaliacoes = "{:<100}".format(num_avaliacoes)
                #concatenação dos valores de cada linha
                linha = contador_str + titulo + autores + editora + data_publicacao + categorias + num_avaliacoes
